...
export const getBlogList = async () => {
  const response = await fetch(
    `${process.env.STRAPI_URL}/cp-blogs/?populate=*`,
    requestOptions
  );
...
export const getBlogListPagination = async (page,PER_PAGE) => {
  ...
  const res = await fetch(
    `${process.env.STRAPI_URL}/cp-blogs/?populate=*&?sort=id:desc&pagination[page]=${page}&pagination[pageSize]=${PER_PAGE}`,
    requestOptions
  );
...
export const getSingleBlog = async (slug) => {
  const response = await fetch(
    `${process.env.STRAPI_URL}/cp-blogs?filters[slug][$eq]=${slug}&populate=*`,
    requestOptions
  );
...
export const getCategoriesBlogList = async (slug) => {
  const response = await fetch(
    `${process.env.STRAPI_URL}/cp-blogs?filters[categories][$eq]=${slug}&populate=*`,
    requestOptions
  );
...
export const getEbookList = async () => {
  const response = await fetch(
    `${process.env.STRAPI_URL}/cp-ebooks?populate=*`,
    requestOptions
  );
